...
public:
    ...
    void SendGroupMsg(const std::string& group_id, const std::string& content, 
                      const std::string& msg_unique_id);
    void SendAddFriendReq(const std::string& target_name, const std::string& sender_name,
    ...
    void SendResponeToFriendReqsReq(const std::string& user_id, const std::string& peer_id, 
                                    int32_t status);
